...
export default function About() {
  ...
  return (
    ...
    <div className="about-content">
      ...
      <DropdownMenu
        title='Respect' widthDesktop='80%'> <span className='dropdown-item'> {dropdownContent[2]} </span>
      </DropdownMenu>
      <DropdownMenu
        title='Service' widthDesktop='80%'> <span className='dropdown-item'> {dropdownContent[2]} </span>
      </DropdownMenu>
      <DropdownMenu
        title='Sécurité' widthDesktop='80%'> <span className='dropdown-item'> {dropdownContent[3]} </span>
      </DropdownMenu>
    </div>
    <Footer />
    </div>
